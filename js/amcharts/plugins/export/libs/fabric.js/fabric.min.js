...
"undefined" != typeof exports && (exports.fabric = fabric), "undefined" != typeof document && "undefined" != typeof window ? (fabric.document = document, fabric.window = window, window.fabric = fabric) : (fabric.document = require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"), fabric.document.createWindow ? fabric.window = fabric.document.createWindow() : fabric.window = fabric.document.parentWindow), fabric.isTouchSupported = "ontouchstart" in fabric.document.documentElement, fabric.isLikelyNode = "undefined" != typeof Buffer && "undefined" == typeof window, fabric.SHARED_ATTRIBUTES = ["display", "transform", "fill", "fill-opacity", "fill-rule", "opacity", "stroke", "stroke-dasharray", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "id"], fabric.DPI = 96, fabric.reNum = "(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)", fabric.fontPaths = {}, fabric.devicePixelRatio = fabric.window.devicePixelRatio || fabric.window.webkitDevicePixelRatio || fabric.window.mozDevicePixelRatio || 1, function() {
    function t(t, e) {
    ...
    fabric.util = {
        ...
        populateWithProperties: function(t, e, i) {
            if (i && "[object Array]" === Object.prototype.toString.call(i)) for (var r = 0, n = i.length; n > r; r++) i[r] in t && (e[i[r]] = t[i[r]])
        },
    ...
    function t(t, r, s, o, h, c, l) {
        ...
        var k = O * s * y / o,
            ...
            M = g * k + p * j + .5 * r,
            P = i(1, 0, (m - k) / s, (y - j) / o),
            L = i((m - k) / s, (y - j) / o, (-m - k) / s, (-y - j) / o);
        0 === c && L > 0 ? L -= 2 * f : 1 === c && 0 > L && (L += 2 * f);
        for (var D = Math.ceil(Math.abs(L / f * 2)), E = [], I = L / D, R = 8 / 3 * Math.sin(I / 4) * Math.sin(I / 4) / Math.sin(I / 2), B = P + I, F = 0; D > F; F++) E[F] = e(P, B, p, g, s, o, A, M, R, v, b), v = E[F][4], b = E[F][5], P = B, B += I;
        return n[u] = E, E
    }
    ...
    function r(t, e, i, r, n, s, h, c) {
        ...
        for (var O = 0; 2 > O; ++O) if (O > 0 && (f = 6 * e - 12 * r + 6 * s, u = -3 * e + 9 * r - 9 * s + 3 * c, d = 3 * r - 3 * e), S(u) < 1e-12) {
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(t) {
        ...
        for (var n = r >= 0 ? r : Math.max(i - Math.abs(r), 0); i > n; n++) if (n in e && e[n] === t) return n;
        return -1
        ...
        for (var i = 0, r = this.length >>> 0; r > i; i++) if (i in this && !t.call(e, this[i], i, this)) return !1;
        return !0
    }), Array.prototype.some || (Array.prototype.some = function(t, e) {
        for (var i = 0, r = this.length >>> 0; r > i; i++) if (i in this && t.call(e, this[i], i, this)) return !0;
        return !1
    ...
    function t(t) {
        var e, i, r = Array.prototype.slice.call(arguments, 1),
            n = r.length;
        for (i = 0; n > i; i++) if (e = typeof t[r[i]], !/^(?:function|object|unknown)$/.test(e)) return !1;
        return !0
    }
    function e(t, e) {
        return {
    ...
    function r(t, e) {
        return function(i) {
            if (p[t] && p[t][e]) for (var r = p[t][e], n = 0, s = r.length; s > n; n++) r[n].call(this, i || fabric.window.event)
        }
    }
    function n(t) {
    ...
    f ? (l = function(t, e, i) {
        ...
        var r, n = c(t);
        if (g[n] && g[n][e]) for (var s = 0, o = g[n][e].length; o > s; s++) r = g[n][e][s], r && r.handler === i && (t.detachEvent("on" + e, r.wrappedHandler), g[n][e][s] = null)
    }) : (l = function(t, e, i) {
        var n = c(t);
        if (p[n] || (p[n] = {}), !p[n][e]) {
            p[n][e] = [];
        ...
        var r = c(t);
        if (p[r] && p[r][e]) for (var n = p[r][e], s = 0, o = n.length; o > s; s++) n[s] === i && n.splice(s, 1)
    ...
    function t(t, e) {
        ...
        for (var r in e) if ("opacity" === r) s(t, e[r]);
        else {
    ...
    var l;
    l = fabric.document.defaultView && fabric.document.defaultView.getComputedStyle ?
    function(t, e) {
    ...
    function t(t) {
        e(function(i) {
            ...
            t.onStart && t.onStart(), function d(i) {
                r = i || +new Date;
                var u = r > o ? s : r - n;
    ...
    var i = fabric.window.requestAnimationFrame || fabric.window.webkitRequestAnimationFrame || fabric.window.mozRequestAnimationFrame || fabric.window.oRequestAnimationFrame || fabric.window.msRequestAnimationFrame ||
    function(t) {
    ...
    function i(t, e, i, r) {
        ...
        return "fill" !== t && "stroke" !== t || "none" !== e ? "strokeDashArray" === t ? e = e.replace(/,/g, " ").split(/\s+/).map(function(t) {
            return parseFloat(t)
        }) : "transformMatrix" === t ? e = i && i.transformMatrix ? x(i.transformMatrix, p.parseTransformAttribute(e)) : p.parseTransformAttribute(e) : "visible" === t ? (e = "none" !== e && "hidden" !== e, i && i.visible === !1 && (e = !1)) : "originX" === t ? e = "start" === e ? "left" : "end" === e ? "right" : "center" : n = s ? e.map(_) : _(e, r) : e = "", !s && isNaN(n) ? e : n
    }
    function r(t) {
        for (var e in k) if ("undefined" != typeof t[k[e]] && "" !== t[e]) {
    ...
    function o(t, e) {
        var i = {};
        for (var r in p.cssRules[e]) if (a(t, r.split(" "))) for (var n in p.cssRules[e][r]) i[n] = p.cssRules[e][r][n];
        return i
    }
    function a(t, e) {
        var i, r = !0;
    ...
    v(p, {
        ...
        createSVGFontFacesMarkup: function(t) {
            for (var e, i, r, n, s, o, a, h = "", c = {}, l = p.fontPaths, u = 0, f = t.length; f > u; u++) if (e = t[u], i = e.fontFamily, -1 !== e.type.indexOf("text") && !c[i] && l[i] && (c[i] = !0, e.styles)) {
                r = e.styles;
                for (s in r) {
                    n = r[s];
    ...
    for (var t = 0, e = this.elements.length; e > t; t++) this.elements[t].setAttribute("svgUid", this.svgUid), function(t, e) {
        setTimeout(function() {
    ...
    fabric.Gradient = fabric.util.createClass({
        ...
        toLive: function(t, e) {
            ...
            if (this.type) {
                if (e.group && "path-group" === e.group.type) for (r in n) "x1" === r || "x2" === r ? n[r] += -this.offsetX + e.width / 2 : "y1" !== r && "y2" !== r || (n[r] += -this.offsetY + e.height / 2);
...
//        n = new Error("Could not initialize `canvas` element");
    fabric.StaticCanvas = fabric.util.createClass({
        ...
        _chooseObjectsToRender: function() {
            ...
            if (e && !this.preserveObjectStacking) {
                for (var n = 0, s = this._objects.length; s > n; n++) t = this._objects[n], e.contains(t) ? r.push(t) : i.push(t);
                e._set("_objects", r)
        ...
        sendToBack: function(t) {
            ...
            if (t === s) for (n = s._objects, e = n.length; e--;) r = n[e], i(this._objects, r), this._objects.unshift(r);
        ...
        bringToFront: function(t) {
            if (!t) return this;
            var e, r, n, s = this.getActiveGroup ? this.getActiveGroup() : null;
            if (t === s) for (n = s._objects, e = 0; e < n.length; e++) r = n[e], i(this._objects, r), this._objects.push(r);
        ...
        sendBackwards: function(t, e) {
            ...
            if (t === h) for (a = h._objects, r = 0; r < a.length; r++) n = a[r], s = this._objects.indexOf(n), 0 !== s && (o = s - 1, i(this._objects, n), this._objects.splice(o, 0, n));
        ...
        bringForward: function(t, e) {
            if (!t) return this;
            var r, n, s, o, a, h = this.getActiveGroup ? this.getActiveGroup() : null;
            if (t === h) for (a = h._objects, r = a.length; r--;) n = a[r], s = this._objects.indexOf(n), s !== this._objects.length - 1 && (o = s + 1, i(this._objects, n), this._objects.splice(o, 0, n));
    ...
    onMouseUp: function() {
        var t = this.canvas.renderOnAddRemove;
        this.canvas.renderOnAddRemove = !1;
        for (var e = [], i = 0, r = this.sprayChunks.length; r > i; i++) for (var n = this.sprayChunks[i], s = 0, o = n.length; o > s; s++) {
    ...
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
        ...
        _normalizePointer: function(t, e) {
            ...
            return s && (r = fabric.util.multiplyTransformMatrices(this.viewportTransform, n.calcTransformMatrix()), r = fabric.util.invertTransform(r), e = fabric.util.transformPoint(e, r, !1), i = fabric.util.transformPoint(n.getCenterPoint(), r, !1), e.x -= i.x, e.y -= i.y), {
                x: e.x,
                y: e.y
            }
        },
        isTargetTransparent: function(t, e, i) {
            ...
            t.hasBorders = t.transparentCorners = !1, o && (s.save(), s.transform.apply(s, t.group.calcTransformMatrix())), t.render(s), t.active && t._renderControls(s), t.hasBorders = r, t.transparentCorners = n;
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        __onMouseMove: function(t) {
            ...
            if (!("undefined" != typeof t.touches && t.touches.length > 1)) {
                ...
                r ? (i = this.getPointer(t, !0), r.left = i.x - r.ex, r.top = i.y - r.ey, this.renderTop()) : this._currentTransform ? this._transformObject(t) : (e = this.findTarget(t), this._setCursorFromEvent(t, e)), this.fire("mouse:move", {
                    target: e,
                    e: t
                }), e && e.fire("mousemove", {
                    e: t
    ...
    loadFromJSON: function(t, e, i) {
        if (t) {
            ...
            this._enlivenObjects(r.objects, function() {
                n._setBgOverlay(r, e)
            }, i), delete r.objects, delete r.backgroundImage, delete r.overlayImage, delete r.background, delete r.overlay;
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        _findCrossPoints: function(t, e) {
            ...
            for (var l in e) if (h = e[l], !(h.o.y < t.y && h.d.y < t.y || h.o.y >= t.y && h.d.y >= t.y || (h.o.x === h.d.x && h.o.x >= t.x ? (o = h.o.x, a = t.y) : (i = 0, r = (h.d.y - h.o.y) / (h.d.x - h.o.x), n = t.y - i * t.x, s = h.o.y - r * h.o.x, o = -(n - s) / (i - r), a = n + i * o), o >= t.x && (c += 1), 2 !== c))) break;
            return c
        },
    ...
    function t(t, e) {
        if (e) {
            ...
            var i = new fabric.Color(e),
                r = t + ": " + e + "; ",
                n = i.getAlpha();
            return 1 !== n && (r = t + ": " + i.toRgb() + "; ", r += t + "-opacity: " + n.toString() + "; "), r
        }
        return t + ": none; "
    }
    fabric.util.object.extend(fabric.Object.prototype, {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        _findTargetCorner: function(t) {
            ...
            var e, i, r = t.x,
                n = t.y;
            this.__corner = 0;
            for (var s in this.oCoords) if (this.isControlVisible(s) && ("mtr" !== s || this.hasRotatingPoint) && (!this.get("lockUniScaling") || "mt" !== s && "mr" !== s && "mb" !== s && "ml" !== s) && (i = this._getImageLines(this.oCoords[s].corner), e = this._findCrossPoints({
                x: r,
                y: n
        ...
        drawSelectionBackground: function(e) {
            if (!this.selectionBackgroundColor || !this.active || this.group) return this;
            e.save();
            var i = this.getCenterPoint(),
                r = this._calculateCurrentDimensions();
            return e.translate(i.x, i.y), e.rotate(t(this.angle)), e.fillStyle = this.selectionBackgroundColor, e.fillRect(-r.x / 2, -r.y / 2, r.x, r.y), e.restore(), this
        },
    ...
    return e.Polygon ? void e.warn("fabric.Polygon is already defined") : (e.Polygon = e.util.createClass(e.Object, {
        ...
        toSVG: function(t) {
            ...
            return this.group && "path-group" === this.group.type || (e = " translate(" + -this.pathOffset.x + ", " + -this.pathOffset.y + ") "), r.push("<", this.type, " ", 'points="', i.join(""), '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), e, " ", this.getSvgTransformMatrix(), '"/>\n'), t ? t(r.join("")) : r.join("")
        },
        _render: function(t, e) {
        ...
        _parsePath: function() {
            for (var t, e, i, r, n, s = [], o = [], c = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi, l = 0, u = this.path.length; u > l; l++) {
                ...
                var g = n[0],
                    p = a[g.toLowerCase()],
                    v = h[g] || g;
                if (n.length - 1 > p) for (var b = 1, m = n.length; m > b; b += p) s.push([g].concat(n.slice(b, b + p))), g = v;
                else s.push(n)
            }
            return s
        },
    ...
    if (!e.Group) {
        ...
        e.Group = e.util.createClass(e.Object, e.Collection, {
            ...
            _calcBounds: function(t) {
                for (var e, i, r, n = [], s = [], o = ["tr", "br", "bl", "tl"], a = 0, h = this._objects.length, c = o.length; h > a; ++a) for (e = this._objects[a], e.setCoords(), r = 0; c > r; r++) i = o[r], n.push(e.oCoords[i].x), s.push(e.oCoords[i].y);
    ...
    e.Image.filters.Convolute = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function(t) {
            for (var e, i, r, n, s, o, a, h, c, l = this.matrix, u = t.getContext("2d"), f = u.getImageData(0, 0, t.width, t.height), d = Math.round(Math.sqrt(l.length)), g = Math.floor(d / 2), p = f.data, v = f.width, b = f.height, m = u.createImageData(v, b), y = m.data, _ = this.opaque ? 1 : 0, x = 0; b > x; x++) for (var S = 0; v > S; S++) {
                s = 4 * (x * v + S), e = 0, i = 0, r = 0, n = 0;
                for (var C = 0; d > C; C++) for (var w = 0; d > w; w++) a = x + C - g, o = S + w - g, 0 > a || a > b || 0 > o || o > v || (h = 4 * (a * v + o), c = l[C * d + w], e += p[h] * c, i += p[h + 1] * c, r += p[h + 2] * c, n += p[h + 3] * c);
    ...
    e.Image.filters.Pixelate = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function(t) {
            var e, i, r, n, s, o, a, h = t.getContext("2d"),
                ...
                u = c.height,
                f = c.width;
            for (i = 0; u > i; i += this.blocksize) for (r = 0; f > r; r += this.blocksize) {
                e = 4 * i * f + 4 * r, n = l[e], s = l[e + 1], o = l[e + 2], a = l[e + 3];
                for (var d = i, g = i + this.blocksize; g > d; d++) for (var p = r, v = r + this.blocksize; v > p; p++) e = 4 * d * f + 4 * p, l[e] = n, l[e + 1] = s, l[e + 2] = o, l[e + 3] = a
            }
    ...
    e.Image.filters.Resize = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        lanczosResize: function(t, e, o, a, l) {
            ...
            function f(t) {
                ...
                for (T.x = (t + .5) * y, k.x = r(T.x), h = 0; l > h; h++) {
                    for (T.y = (h + .5) * _, k.y = r(T.y), g = 0, j = 0, A = 0, M = 0, P = 0, c = k.x - C; c <= k.x + C; c++) if (!(0 > c || c >= e)) {
                        L = r(1e3 * s(c - T.x)), O[L] || (O[L] = {});
                        for (var E = k.y - w; E <= k.y + w; E++) 0 > E || E >= o || (D = r(1e3 * s(E - T.y)), O[L][D] || (O[L][D] = m(n(i(L * x, 2) + i(D * S, 2)) / 1e3)), u = O[L][D], u > 0 && (d = 4 * (E * e + c), g += u, j += u * v[d], A += u * v[d + 1], M += u * v[d + 2], P += u * v[d + 3]))
                    }
        ...
        bilinearFiltering: function(t, e, i, n, s) {
            var o, a, h, c, l, u, f, d, g, p, v, b, m, y = 0,
                ...
                k = T.data;
            for (f = 0; s > f; f++) for (d = 0; n > d; d++) for (l = r(_ * d), u = r(x * f), g = _ * d - l, p = x * f - u, m = 4 * (u * e + l), v = 0; 4 > v; v++) o = O[m + v], a = O[m + 4 + v], h = O[m + C + v], c = O[m + C + 4 + v], b = o * (1 - g) * (1 - p) + a * g * (1 - p) + h * p * (1 - g) + c * g * p, k[y++] = b;
            return T
        },
        hermiteFastResize: function(t, e, i, o, a) {
            for (var h = this.rcpScaleX, l = this.rcpScaleY, u = c(h / 2), f = c(l / 2), d = t.getContext("2d"), g = d.getImageData(0, 0, e, i), p = g.data, v = d.getImageData(0, 0, o, a), b = v.data, m = 0; a > m; m++) for (var y = 0; o > y; y++) {
                for (var _ = 4 * (y + m * o), x = 0, S = 0, C = 0, w = 0, O = 0, T = 0, k = 0, j = (m + .5) * l, A = r(m * l);
                (m + 1) * l > A; A++) for (var M = s(j - (A + .5)) / f, P = (y + .5) * h, L = M * M, D = r(y * h);
                (y + 1) * h > D; D++) {
                    var E = s(P - (D + .5)) / u,
                        I = n(L + E * E);
    ...
    a.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor"), e.Text = e.util.createClass(e.Object, {
        ...
        _renderTextFill: function(t) {
            if (this.fill || !this.isEmptyStyles()) for (var e = 0, i = 0, r = this._textLines.length; r > i; i++) {
    ...
    fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
        ...
        renderSelection: function(t, e, i) {
            ...
            for (var r = this.get2DCursorLocation(this.selectionStart), n = this.get2DCursorLocation(this.selectionEnd), s = r.lineIndex, o = n.lineIndex, a = s; o >= a; a++) {
                var h = this._getLineLeftOffset(this._getLineWidth(i, a)) || 0,
                    ...
                    l = 0,
                    u = this._textLines[a];
                if (a === s) for (var f = 0, d = u.length; d > f; f++) f >= r.charIndex && (a !== o || f < n.charIndex) && (l += this._getWidthOfChar(i, u[f], a, f)), f < r.charIndex && (h += this._getWidthOfChar(i, u[f], a, f));
                else if (a > s && o > a) l += this._getLineWidth(i, a) || 5;
                else if (a === o) for (var g = 0, p = n.charIndex; p > g; g++) l += this._getWidthOfChar(i, u[g], a, g);
        ...
        _renderTextLinesBackground: function(t) {
            ...
            for (var e, i, r, n, s, o, a = 0, h = this._getLeftOffset(), c = this._getTopOffset(), l = 0, u = this._textLines.length; u > l; l++) if (e = this._getHeightOfLine(t, l), n = this._textLines[l], "" !== n && this.styles && this._getLineStyle(l)) {
        ...
        _applyCharStylesGetWidth: function(e, i, r, n, s) {
            var o, a = this._getStyleDeclaration(r, n),
                h = s && t(s) || t(a);
            this._applyFontStyles(h);
            var c = this._getCacheProp(i, h);
            if (!a && this._charWidthsCache[c] && this.caching) return this._charWidthsCache[c];
            "string" == typeof h.shadow && (h.shadow = new fabric.Shadow(h.shadow));
            var l = h.fill || this.fill;
            return e.fillStyle = l.toLive ? l.toLive(e, this) : l, h.stroke && (e.strokeStyle = h.stroke && h.stroke.toLive ? h.stroke.toLive(e, this) : h.stroke), e.lineWidth = h.strokeWidth || this.strokeWidth, e.font = this._getFontDeclaration.call(h), h.shadow && (h.scaleX = this.scaleX, h.scaleY = this.scaleY, h.canvas = this.canvas, this._setShadow.call(h, e)), this.caching && this._charWidthsCache[c] ? this._charWidthsCache[c] : (o = e.measureText(i).width, this.caching && (this._charWidthsCache[c] = o), o)
        },
