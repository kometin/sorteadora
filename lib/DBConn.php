    ...
    public function Connect(){
        switch($this->protocol){
            case "MYSQL":
                ...
                mysqli_select_db($this->cn, $this->connection[$this->active]['DB']);
                
            break;
            case "MSSQL":
                $this->cn = mssql_connect($this->connection[$this->active]['HOST'], 
                                          $this->connection[$this->active]['USER'],
                                          $this->connection[$this->active]['PWD'])
                                          or die($this->Error("Error de conexion"));
                mssql_select_db($this->connection[$this->active]['DB'], $this->cn);
            break;
            case "SQLDRIVER":
