...
<form id="op"  autocomplete="off">
    <table id="tblfactores" class="table table-striped">
        ...
        <tr id="tr<?=$row['id']?>">
            <td><input type="text" name="Factor[]" class="form-control require" placeholder="Descripción del defecto"  value="<?=$row['Factor']?>"></td>  
            <td>
        ...
        <? }}else{?>
        <tr id="tra">
            <td><input type="text" name="Factor[]" class="form-control require" placeholder="Descripción del defecto"  value=""></td>  
